...
```bash
gh project item-create 1 --owner tomdevelophaha --title "<task name>"
```

With surrounding context — add a body:

```bash
gh project item-create 1 --owner tomdevelophaha --title "<task name>" --body "<1-2 sentence what + why>"
```
...
- Editing existing items — use `gh project item-edit 1 ...`.
